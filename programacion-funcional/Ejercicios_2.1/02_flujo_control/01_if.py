...
if edad >= 18 or tiene_carnet:
    print("Puedes conducir en la Isla Holbox 🏝️")
else:
    print("Paga a la policía y te dejará conducir!!!")
...
# [código si cumple la condición] if [condicion] else [código si no cumple]
